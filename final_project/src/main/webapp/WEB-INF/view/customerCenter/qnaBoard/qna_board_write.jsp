...
<body>
<form action="BoardAddAction.sh" method="post" 
...
<table cellpadding="0" cellspacing="0" border=0 align="center" width=80% id="tborder">
	...
	<tr>
		...
		<td>
			<input name="qnaName" type="text" size="10" maxlength="10" 
				value=""/>
		</td>
	</tr>
	<tr>
		...
		<td>
			<input name="qnaSubject" type="text" size="50" maxlength="100" 
				value=""/>
		</td>
	</tr>
	<tr>
