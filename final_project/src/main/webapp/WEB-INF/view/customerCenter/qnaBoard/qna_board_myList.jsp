...
<%-- <% if((listCount > 0) && (id != null )) { %> --%>
	...
	<tr align="center" valign="middle" bordercolor="#333333">
		...
		<td style="font-family:Tahoma;font-size:10pt;" width="53%">
...
<%-- 	<%
	...
	<tr align="center" valign="middle" bordercolor="#333333"
		...
		<td height="23" style="font-family:Tahoma;font-size:10pt;" align="center" id="border4">
			<%-- <%=dto.getQnaNum()%> --%> 번호
		</td>
		...
		<td style="font-family:Tahoma;font-size:10pt;" align="left" >
			...
			<a href="#<%-- BoardDetailAction.sh?num=<%=dto.getQnaNum()%> --%>">
				<%-- <%=dto.getQnaSubject()%> --%>제목
			</a>
		...
		<td style="font-family:Tahoma;font-size:10pt;"align="center" >
			<%-- <%=dto.getQnaName()%> --%>이름
		</td>
		<td style="font-family:Tahoma;font-size:10pt;"align="center" >
			<%-- <%=dto.getQnaDate()%> --%> 작성일
